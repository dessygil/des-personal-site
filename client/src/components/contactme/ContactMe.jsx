          ...
          <div className="contact-text-container">
            ...
            <div className="social-links">
              <a href="https://stackoverflow.com/users/12100881/desmond-gilmour">
                <i className="contact-social-icon fa-brands fa-stack-overflow"></i>
              </a>
              <a href="https://github.com/dessygil">
                <i className="contact-social-icon fa-brands fa-github"></i>
              </a>
              <a href="https://www.linkedin.com/in/desmond-gilmour-886b3a128/">
                <i className="contact-social-icon fa-brands fa-linkedin-in"></i>
              </a>
            </div>
          </div>
        </div>
